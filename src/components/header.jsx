        ...
        <nav className="relative">
            <div className=" bg-[#EBE6D4]  sm:h-17 h-11 w-full sm:px-10 px-5 flex items-center justify-between text-[#072629]">
                ...
                <div className="sm:flex lg:gap-10 gap-5 text-base font-medium items-center hidden">
                    <Link to="/favorite" className=" flex items-center gap-1 hover:rounded-full hover:bg-amber-50 px-2 py-2"><Heart className="lg:size-7  p-1 rounded-full border-2 text-[#072629ad] hover:fill-[#072629ad]" /> favorite</Link>
                    ...
                    {user && (
                        <div className="flex lg:gap-10 gap-5">
                            <Link to="/profile" className="flex gap-1 items-center hover:rounded-full hover:bg-amber-50 px-2 py-2"><UserRound className="lg:size-7  p-1 rounded-full text-[#072629ad] border-2 hover:fill-[#072629ad]" strokeWidth={2} />My Account</Link>
